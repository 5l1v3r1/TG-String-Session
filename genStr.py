...
"""
    reply_markup = InlineKeyboardMarkup(
        [
            [
                InlineKeyboardButton('Support Channel', url='https://t.me/AyushBots'),
                InlineKeyboardButton('Developer', url='https://t.me/CyberBoyAyush')
            ],
            [
                InlineKeyboardButton('Msg For Any Help', url='https://t.me/CyberBoyAyushBot'),
            ]
        ]
    )
